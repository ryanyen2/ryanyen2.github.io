...
<!-- > <img src="/assets/images/icons/warning-triangle.svg" alt="Warning Triangle Icon" style="width: 24px; height: 24px; vertical-align: middle;">
This is a shared work and collaborative thought submitted to the [CHI 2025 Tools for Thought Workshop](https://ai-tools-for-thought.github.io/workshop/), with [Josh Pollock](https://joshmpollock.com/), [Caroline Berger](https://carolineberger.github.io/), and [Arvind Satyanarayan](https://arvindsatya.com/), the full article is available [at the MIT VIS Lab Website](https://vis.csail.mit.edu/pubs/). -->
...
style="width: 100%; max-width: 374px; height: auto;" />
...
<figure id="figure4">
<img src="/assets/images/semi-formal/livelit-example.png" alt="Figure 4: The example of using Livelits showed in Figure 1 of the paper" style="width: 100%; max-width: 374px; height: auto;" />
...
<figure id="figure7b">
<img src="/assets/images/semi-formal/receipt-taiwan.png" alt="Figure 7 (b): A receipt from a convenience store in Taiwan, which has different attributes, in a different language, and using a different year-counting system then CE" style="width: 100%; max-width: 374px; height: auto;" />
...
<!-- <video muted autoplay controls width="100%" height="400">
    <source src="/assets/videos/workshop_demo_1.mp4" type="video/mp4">
</video> -->

<!-- {% include video.html id="workshop_demo_1" title="Demo of extracting products information from the website" %} -->
...
<!-- <video muted autoplay controls width="100%" height="400">
    <source src="/assets/videos/workshop_demo_2.mp4" type="video/mp4">
</video> -->
<!-- {% include video.html id="workshop_demo_2" title="Demo of extracting color palette from external images" %} -->
...
<!-- <video muted autoplay controls width="100%" height="400">
    <source src="/assets/videos/RGHMT0jJSMA.mp4" type="video/mp4">
</video> -->
